...
| `Script: Track Edit Mirror (Splits, Fades, Stretch Markers).lua`|  Mirrors edits from reference track to target track including item positions and lengths, fades and fade shapes/directions, stretch markers| `Editing/Script: Track Edit Mirror (Splits, Fades, Stretch Markers).lua`|
...
| `Script: Smart Retake (Non-Destructive) from Play or Edit Cursor.lua`| Performs a smart retake from the play or edit cursor with minimal delay, without deleting previous takes. Ideal for fast, non-destructive punch-ins.| `Recording/Script: Smart Retake (Non-Destructive) from Play or Edit Cursor.lua`|
